...
namespace OpGL
{
    public class AnimatedColor
    {
        ...
        public static AnimatedColor Default => new AnimatedColor(new List<Color>() { Color.FromArgb(230, 230, 230) }, 0.07f, 1f, 10, 60);
        public static AnimatedColor Flashy => new AnimatedColor(new List<Color>() { Color.FromArgb(165, 20, 255), Color.FromArgb(155, 15, 240), Color.FromArgb(255, 255, 255), Color.FromArgb(200, 255, 205) }, 0.05f, 0.05f, 2, 60);
