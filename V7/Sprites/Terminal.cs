...
namespace V7
{
    public class Terminal : Sprite, IActivityZone
    {
        ...
        public VTextBox OwnTextBox { get => ivTextBox ?? TextBox; set => ivTextBox = value; }
        ...
        private SoundEffect ivActivateSound;
        public SoundEffect OwnActivateSound { get => ivActivateSound ?? ActivateSound; set => ivActivateSound = value; }
        public Game Owner;
