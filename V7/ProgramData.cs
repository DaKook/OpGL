...
namespace V7
{
    public class ProgramData
    {
        ...
        public int MainLightLocation;
        public int LightsLocation;
        ...
        public ProgramData(int id)
        {
            ...
            ViewMatrixLocation = GL.GetUniformLocation(id, "view");
            MainLightLocation = GL.GetUniformLocation(id, "mainLight");
            LightsLocation = GL.GetUniformLocation(id, "lights");
            LightCountLocation = GL.GetUniformLocation(id, "lightCount");
            ViewMatrixLocation = GL.GetUniformLocation(id, "view");
        }
