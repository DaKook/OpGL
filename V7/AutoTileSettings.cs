...
namespace V7
{
    public class AutoTileSettings
    {
        public struct RoomPreset
        {
            ...
            public RoomPreset(Initializer ground, Initializer background, Initializer spikes, Color color, TileTexture texture, string name = "")
            {
                Ground = ground;
        ...
        public class PresetGroup : SortedList<string, RoomPreset>
        {
            ...
            {
                if (TryGetValue(name ?? "", out RoomPreset preset)) return preset;
                else return new RoomPreset(new Initializer(name, new Point(0, 0), 13, new Point(1, 1)), new Initializer(name, new Point(0, 0), 13, new Point(1, 1)), new Initializer(name, new Point(0, 0), 13, new Point(1, 1)), Color.White, null);
            }
            ...
            public void AddRange(IEnumerable<RoomPreset> presets)
            {
