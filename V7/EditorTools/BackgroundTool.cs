...
namespace V7
{
    public class BackgroundTool : TilesTool
    {
        public override string DefaultName => "Background";
        ...
        public override string DefaultKey => "2";

        public override Keys DefaultKeybind => Keys.D2;

        public override bool IsAuto => true;

        protected AutoTileSettings autoTiles => Owner.CurrentRoom?.Background;

        public BackgroundTool(LevelEditor parent, TileTexture texture) : base(parent, texture)
        {
        ...
        protected override void PlaceTiles(bool delete = false)
        {
            ...
            Owner.AutoTilesToolMulti(pts, !delete, LevelEditor.Tools.Background, autoTiles, Layer, Texture, 'b');
        }

        protected override void Fill()
        {
            Owner.TileFillTool(Owner.CameraX + position.X, Owner.CameraY + position.Y, left, LevelEditor.Tools.Background, autoTiles, Tile, Layer, Texture, 'b');
        }
    }
}
